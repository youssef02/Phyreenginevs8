...
#ifndef PHYRE_ANIMATION_TARGET_BLENDER_CONTROLLER_INL
#define PHYRE_ANIMATION_TARGET_BLENDER_CONTROLLER_INL
...
namespace Phyre
{
	namespace PAnimation
	{
		...
		PUInt32 PAnimationTargetBlenderController::getSourceCount() const
		{
			return 1;
		}

		// Gets m_animDataSource.
		PAnimationDataSource *PAnimationTargetBlenderController::getSource() const
		{
		...
		PAnimationDataSource *PAnimationTargetBlenderController::getSource(PUInt32 index) const
		{
...
#endif //! PHYRE_ANIMATION_TARGET_BLENDER_CONTROLLER_INL
